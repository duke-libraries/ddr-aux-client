  ...
  RSpec.describe Client do
    ...
    describe ".get_license" do
      it "calls License.get" do
        expect(Client::Api::License).to receive(:get).with(1) { nil }
    ...
    describe ".get_licenses" do
      it "calls License.list" do
        expect(Client::Api::License).to receive(:list) { [] }
        Client.get_licenses
      end
    end
    ...
    describe ".find_license" do
      it "calls License.find" do
        expect(Client::Api::License).to receive(:find).with(foo: "bar") { nil }
    ...
    describe ".get_admin_set" do
      it "calls AdminSet.get" do
        expect(Client::Api::AdminSet).to receive(:get).with(1) { nil }
    ...
    describe ".get_admin_sets" do
      it "calls AdminSet.list" do
        expect(Client::Api::AdminSet).to receive(:list) { [] }
    ...
    describe ".find_admin_set" do
      it "calls AdminSet.find" do
        expect(Client::Api::AdminSet).to receive(:find).with(foo: "bar") { nil }
